...
export class ProduitService {
  ...
  deleteById(produit: Produit) {
    ...
    return this.http.delete(
      `${api_url}/shopix-api/produits/id/${produit.id}`,
      httpOptions
    );
  }
  ...
  update(id: number, prod: Produit) {
    ...
    return this.http.put(
      `${api_url}/shopix-api/produits/id/${id}`,
      prod,
      httpOptions
    );
  }
  findByLibelle(prod: Produit) {
    return this.http.get(
      `${api_url}/shopix-api/produits/libelle/${prod.libelle}`
    );
  }
  nbrProduit() {
  ...
  findByCategorie(categorie: string) {
    return this.http.get(
      `${api_url}/shopix-api/produits/categorie/${categorie}`
    );
  }
